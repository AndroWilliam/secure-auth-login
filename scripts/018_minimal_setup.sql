-- Minimal Setup - Only add what's needed for user management
-- This script doesn't assume any existing columns
...
-- Set admin user (only updating role, not inserting)
UPDATE profiles 
